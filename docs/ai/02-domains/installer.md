...
touches_code:
  ...
  - modules/Installer/app/Providers/RouteServiceProvider.php
...
ماژول `Installer` یکی از ماژول‌های Concord/ErpSmart است. وضعیت و جزئیات دقیق باید هنگام هر تسک با کد validate شود.
