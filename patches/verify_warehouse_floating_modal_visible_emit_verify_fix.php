...
$visibleUpdateWithEmit = str_contains($component, <<<'TEXT'
@update:visible="emit('update:visible', $event)"
TEXT) || str_contains($component, <<<'TEXT'
@update:visible="$emit('update:visible', $event)"
TEXT);

$hiddenWithEmit = str_contains($component, <<<'TEXT'
@hidden="emit('hidden')"
TEXT) || str_contains($component, <<<'TEXT'
@hidden="$emit('hidden')"
TEXT);
...
$checks = [
    ...
    'uses_core_visible_model' => $visibleUpdateWithEmit,
    'emits_hidden_to_core' => $hiddenWithEmit,
